...
export function SearchInput() {
  ...
  return (
    <form onSubmit={onSubmit}>
      <Row className="relative mb-0 mt-[24px] min-h-[40px] w-full flex-wrap items-center rounded-full border border-gray-300 text-button-secondary-foreground tb:mb-[24px]">
